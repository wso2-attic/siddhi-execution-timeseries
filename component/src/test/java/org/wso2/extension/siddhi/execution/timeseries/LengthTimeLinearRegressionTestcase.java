...
/**
 * Tests for lengthTimeRegress Extension.
 */
public class LengthTimeLinearRegressionTestcase {
    ...
    public void simpleRegressionTest1() throws Exception {
        ...
        String siddhiApp = ("@info(name = 'query1') from InputStream#timeseries:lengthTimeRegress(1 day, 20, y, x) "
        ...
        AssertJUnit.assertEquals("Beta1: ", 72.19854041916172, betaOne, 72.19854041916172 - betaOne);
    ...
    public void simpleRegressionTest2() throws Exception {
        ...
        String siddhiApp = ("@info(name = 'query1') from InputStream#timeseries:lengthTimeRegress(200, 10000, y, x) "
                + "select * " + "insert into OutputStream;");
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager
                .createSiddhiAppRuntime(inputStream + siddhiApp);
    ...
    public void multipleRegressionTest1() throws Exception {
        ...
        // Limit number of events based on length window (query):
        String eventFuseSiddhiApp = ("@info(name = 'query2') " +
                "from InputStream#timeseries:lengthTimeRegress(20 days, 30, 1, 0.95, a, c, b, e) "
                + "select * " + "insert into OutputStream;");
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager
                .createSiddhiAppRuntime(inputStream + eventFuseSiddhiApp);
        ...
        AssertJUnit.assertEquals("No of events: ", 50, count);
        AssertJUnit.assertEquals("Beta2: ", 26.913229162385804, betaTwo, 26.913229162385804 - betaTwo);
    ...
    public void multipleRegressionTest2() throws Exception {
        ...
        // Limit number of events based on time window (query):
        String eventFuseSiddhiApp = ("@info(name = 'query2') " +
                "from InputStream#timeseries:lengthTimeRegress(200, 10000, 1, 0.95, a, c, b, e) "
                + "select * " + "insert into OutputStream;");
        SiddhiAppRuntime siddhiAppRuntime = siddhiManager
                .createSiddhiAppRuntime(inputStream + eventFuseSiddhiApp);
